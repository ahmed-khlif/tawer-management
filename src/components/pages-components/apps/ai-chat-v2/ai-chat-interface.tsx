...
import aiSphereAnimation from "../../../../app/[locale]/dashboard/(auth)/apps/ai-chat-v2/ai-sphere-animation.json";
import conversations from "../../../../app/[locale]/dashboard/(auth)/apps/ai-chat-v2/data.json";

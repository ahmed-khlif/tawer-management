...
import type { CalendarEventType, EventColor } from "../components/calendar";
 ...
 */
export function isMultiDayEvent(event: CalendarEventType): boolean {
 ...
 */
export function sortEvents(events: CalendarEventType[]): CalendarEventType[] {
 ...
 */
export function getAllEventsForDay(events: CalendarEventType[], day: Date): CalendarEventType[] {
  return events.filter((event) => {
    const eventStart = event.startDate;
    const eventEnd = event.endDate;
    return (
 ...
 */
export function getAgendaEventsForDay(events: CalendarEventType[], day: Date): CalendarEventType[] {
  return events
    .filter((event) => {
      const eventStart = event.startDate;
      const eventEnd = event.endDate;

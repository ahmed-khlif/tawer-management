import { ChartFileTransfer, FileUploadDialog, FolderListCards, StorageStatusCard, SummaryCards, TableRecentFiles } from "@/components/pages-components/file-manager";
